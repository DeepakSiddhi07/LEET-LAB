            ...
            const isSolved = problem.solvedBy.some((user)=>user.userId === authUser?.id);
               ...
               return (
                  <tr key={problem.id}>
                    ...
                    <td>
                      <div className="flex flex-wrap gap-1">
                        {Array.isArray(problem.company) ? 
                          problem.company.map((company, idx) => (
                            <span
                              key={idx}
                          ...
                          problem.company ? (
                            <span className="badge badge-outline badge-info text-xs font-bold">
                              {problem.company}
                            </span>
                          ) : null
                        }
                    ...
                    <td>
                      <span className="badge badge-outline badge-secondary text-xs font-bold">
